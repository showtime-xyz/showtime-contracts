...
export interface ShowtimeBakeSaleInterface extends utils.Interface {
  contractName: "ShowtimeBakeSale";
  functions: {
...
export interface ShowtimeBakeSale extends BaseContract {
  contractName: "ShowtimeBakeSale";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShowtimeBakeSaleInterface;
