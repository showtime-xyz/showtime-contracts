...
export interface CreatorOwnedCollectionTestInterface extends utils.Interface {
  contractName: "CreatorOwnedCollectionTest";
  functions: {
...
export interface CreatorOwnedCollectionTest extends BaseContract {
  contractName: "CreatorOwnedCollectionTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreatorOwnedCollectionTestInterface;
  ...
  functions: {
    ...
    testCreateMintableCollectionViaOnePerAddressContract(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  };
