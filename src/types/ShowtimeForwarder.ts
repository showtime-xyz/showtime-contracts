...
export interface ShowtimeForwarderInterface extends utils.Interface {
  contractName: "ShowtimeForwarder";
  functions: {
...
export interface ShowtimeForwarder extends BaseContract {
  contractName: "ShowtimeForwarder";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShowtimeForwarderInterface;
