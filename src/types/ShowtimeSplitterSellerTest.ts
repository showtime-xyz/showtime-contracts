...
export interface ShowtimeSplitterSellerTestInterface extends utils.Interface {
  contractName: "ShowtimeSplitterSellerTest";
  functions: {
    ...
    "testDeploySalesContractWithBadShares()": FunctionFragment;
    "testDeploySalesContractWithDuplicatePayees()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testDeploySalesContractWithBadShares",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testDeploySalesContractWithDuplicatePayees",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testDeploySalesContractWithNoPayees",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testDeploySalesContractWithPayeesSharesMismatch",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testHappyPathEndToEnd",
...
export interface ShowtimeSplitterSellerTest extends BaseContract {
  contractName: "ShowtimeSplitterSellerTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShowtimeSplitterSellerTestInterface;
  ...
  functions: {
    ...
    testDeploySalesContractWithBadShares(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testDeploySalesContractWithDuplicatePayees(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testDeploySalesContractWithNoPayees(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testDeploySalesContractWithPayeesSharesMismatch(
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    testHappyPathEndToEnd(
      price: BigNumberish,
